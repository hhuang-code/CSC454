...
{
    cout << "Checking switch is on." << endl;

    cout << endl;

	Pointer<int, true> foo(new int[12]);  // a Pointer pointing to an array
	...
	*(foo + 1) -= 10;
	...
	Pointer<int, true> fun;   // default constructor
    ...
    Pointer<int, true> bat;   // default constructor
